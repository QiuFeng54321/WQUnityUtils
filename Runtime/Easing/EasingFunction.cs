...
namespace WilliamQiufeng.UnityUtils.Easing
{
    ...
    public class EasingFunction
    {
        ...
        public static Vector3 CubicBezier(Vector3 from, Vector3 c1, Vector3 c2, Vector3 to, float t)
        {
        ...
        public static float CubicBezier(float from, float c1, float c2, float to, float t)
        {
            var p1 = Lerp(from, c1, t);
            var p2 = Lerp(c1, c2, t);
            var p3 = Lerp(c2, to, t);
